...
- [ ] Fix component name from MultiplayerHoleScoreInput to HoleScoreInput (MultiplayerHoleScoreInput.tsx)
- [ ] Remove unused Prop 'round' from scorecard (scorecard.tsx)
